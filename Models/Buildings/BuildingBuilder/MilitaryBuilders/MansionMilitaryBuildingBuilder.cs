...
{
    public class MansionMilitaryBuildingBuilder : MilitaryBuildingBuilder
    {
        protected override int MIN_LEVEL { get { return 6; } }
        protected override int MAX_LEVEL { get { return 8; } }

        protected override List<SquadType> SQUADS { get { return new List<SquadType>() { SquadType.HeavyInfantry }; } }

        protected override Military MILITARY { get { return  Military.GhostMansion; } }
