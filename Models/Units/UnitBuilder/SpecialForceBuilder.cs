...
{
    public class SpecialForceBuilder : UnitBuilder
    {
        protected override SquadType SQUAD_TYPE { get { return SquadType.SpecialForce; } }
        protected override int UNIT_POWER { get { return UnitPower.SquadsUnitPower[SquadType.SpecialForce]; } }

        protected override Dictionary<ResourceType, int> RESOURCES { get { return new Dictionary<ResourceType, int>()
        {
            [ResourceType.Stone] = 0,
            [ResourceType.Metal] = 750,
            [ResourceType.Rot] = 150,
            [ResourceType.Silk] = 450,
            [ResourceType.Rune] = 0,
        }; } }
        ...
        {
            [UnitCharacteristic.Health] = 600,
            [UnitCharacteristic.Attack] = 140,
            ...
            [UnitCharacteristic.MinDamage] = 40,
            [UnitCharacteristic.MaxDamage] = 50,
        }; } }
        ...
        {
            new AuraOfRotAbility(),
            new TentacleGripAbility(),
        }; } }
    }
}
