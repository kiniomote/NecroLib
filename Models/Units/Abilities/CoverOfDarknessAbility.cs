...
{
    public class CoverOfDarknessAbility : UnitAbility
    {
        public const int RANGE = 5;
        public const int WIDTH = 1;
        public static readonly bool? TARGET_TYPE = Battlefield.FRIEND;
        public static readonly TemporaryEffect EffectCountdown = TemporaryEffect.CoverOfDarknessCountdown;

        public CoverOfDarknessAbility() : base(UnitAbilities.CoverOfDarkness)
        {
        ...
        public override void AddAdditionalActions(List<IUnitAction> unitActions, IBattleUnit battleUnit)
        {
            ...
            magicModifiers.Add(new CoverOfDarknessMagic(EffectCountdown));
